...
to their resource planning, none of them have any time left to decorate the North
Pole!
...
through 99 in order. As you turn the dial, it makes a sm
reaches each number.
...
a decoy. The actual password is the number of times the dial is left pointing at
